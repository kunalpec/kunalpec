...
* **Artificial Intelligence:** Specialized in NLP-based applications and Deep Learning (CNN, RNN, LSTM).
* **Machine Learning:** Predictive modeling using Regression, Classification, and Clustering.
* **Full-Stack Development:** Designing responsive interfaces with React and robust APIs with Django.
