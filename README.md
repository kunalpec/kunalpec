...
I am a Computer Science (Data Science) student at **Punjab Engineering College (PEC)** with a passion for building intelligent systems. My work bridges the gap between robust backend logic and scalable Machine Learning models.
...
* **Artificial Intelligence:** Specialized in NLP-based applications, Deep Learning (CNN, RNN, LSTM), and building agentic AI workflows using LangChain and LangGraph.
* **Machine Learning:** Predictive modeling using Regression, Classification, and Clustering.
